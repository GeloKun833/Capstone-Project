            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card invoices-add-card">
                        <div class="card-body">
                            <form action="<?php echo e(route('invoice/add/save')); ?>" class="invoices-form" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select select2s-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" id="customer_name" name="customer_name">
                                                    ...
                                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $names): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($names->name); ?>" <?php echo e(old('full_name') == $names->name ? "selected" :""); ?>><?php echo e($names->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label>Po Number</label>
                                                <input class="form-control <?php $__errorArgs = ['po_number'];
...
unset($__errorArgs, $__bag); ?>" type="text" id="po_number" name="po_number" placeholder="Enter Reference Number" value="<?php echo e(old('po_number')); ?>">
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="invoice-inner-date invoice-inner-datepic">
                                                                <span>
                                                                    Due Date <input class="form-control datetimepicker <?php $__errorArgs = ['po_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="text" name="due_date" placeholder="Select" value="<?php echo e(old('due_date')); ?>">
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="invoice-add-table">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-center add-table-items" id="invoice-add-table">
                                            ...
                                            <tbody>
                                                <tr class="add-row">
                                                    <td><input type="text" class="form-control <?php $__errorArgs = ['items.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="items[]" value="<?php echo e(old('items.0')); ?>"></td>
                                                    <td><input type="text" class="form-control <?php $__errorArgs = ['category.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="category[]" value="<?php echo e(old('category.0')); ?>"></td>
                                                    <td><input type="text" class="form-control <?php $__errorArgs = ['quantity.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="quantity[]" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?php echo e(old('quantity.0')); ?>"></td>
                                                    <td><input type="text" class="form-control price <?php $__errorArgs = ['price.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="price[]" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?php echo e(old('price.0')); ?>"></td>
                                                    <td><input type="text" class="form-control amount <?php $__errorArgs = ['amount.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="amount[]" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?php echo e(old('amount.0')); ?>"></td>
                                                    <td><input type="text" class="form-control discount <?php $__errorArgs = ['discount.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="discount[]" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?php echo e(old('discount.0')); ?>"></td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-6">
                                        ...
                                        <div class="upload-sign">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control <?php $__errorArgs = ['name_of_the_signatuaory'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="name_of_the_signatuaory" placeholder="Name of the Signatuaory">
                                            </div>
...
unset($__errorArgs, $__bag); ?>" name="items[]">' + '</td>' +
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\invoices\invoice_add.blade.php ENDPATH**/ ?>