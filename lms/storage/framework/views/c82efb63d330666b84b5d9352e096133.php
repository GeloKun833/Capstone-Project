        ...
        <div class="col-12">
            <div class="card modern-card">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted mb-4"><?php echo e($parent['error']); ?></p>
...
<?php elseif(isset($parent['noChildren']) && $parent['noChildren']): ?>
    <!-- No Children State -->
    <div class="row">
        <div class="col-12">
            <div class="card modern-card">
...
<?php elseif(isset($parent['children']) && $parent['children']->count() > 0): ?>
        ...
        <div class="col-12">
            <div class="alert alert-info border-0 shadow-sm" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                <div class="d-flex align-items-center text-white">
                    ...
                    <div>
                        <h5 class="mb-1 text-white fw-bold">Welcome, <?php echo e(auth()->user()->name); ?>!</h5>
                        <p class="mb-0" style="opacity: 0.95;">Monitor your <?php echo e($parent['children']->count() > 1 ? 'children\'s' : 'child\'s'); ?> academic journey and stay connected with their progress.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php if($parent['children']->count() > 1): ?>
        <div class="row mb-4">
            <div class="col-12">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="child-selector-card <?php echo e($parent['selectedChild']->id == $child->id ? 'active' : ''); ?>" 
                                         onclick="switchChild(<?php echo e($child->id); ?>)"
                                        ...
                                        <div class="d-flex align-items-center p-3">
                                            <div class="me-3">
                                                <img src="<?php echo e($child->upload ? asset('storage/' . $child->upload) : URL::to('assets/img/profiles/avatar-01.jpg')); ?>" 
                                                     ...
                                                     style="width: 60px; height: 60px; object-fit: cover; border: 3px solid <?php echo e($parent['selectedChild']->id == $child->id ? '#667eea' : '#e0e0e0'); ?>;">
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1 fw-bold"><?php echo e($child->first_name); ?> <?php echo e($child->last_name); ?></h6>
                                                <p class="mb-0 text-muted small">
                                                    <i class="fas fa-graduation-cap me-1"></i><?php echo e($child->year_level); ?>

                                                </p>
                                                <p class="mb-0 text-muted small">
                                                    <i class="fas fa-chalkboard me-1"></i><?php echo e($child->sections->first() ? $child->sections->first()->name : 'No Section'); ?>

                                                </p>
                                            </div>
                                            <?php if($parent['selectedChild']->id == $child->id): ?>
                                                <div class="ms-2">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-3 text-center mb-4 mb-md-0">
                            <div class="child-photo-wrapper">
                                <?php if(!empty($parent['selectedChild']->upload)): ?>
                                    <img src="<?php echo e(asset('storage/' . $parent['selectedChild']->upload)); ?>" alt="Child Photo" class="child-photo">
                                <?php else: ?>
                                    <img src="<?php echo e(URL::to('assets/img/profiles/avatar-01.jpg')); ?>" alt="Child Photo" class="child-photo">
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <h2 class="text-white mb-1 fw-bold" style="font-size: 2rem; text-shadow: 2px 2px 8px rgba(0,0,0,0.3);">
                                <?php echo e($parent['selectedChild']->first_name); ?> <?php echo e($parent['selectedChild']->middle_name); ?> <?php echo e($parent['selectedChild']->last_name); ?>
                            ...
                            <div class="row g-3">
                                <div class="col-md-3 col-6">
                                    <div class="info-pill text-center">
                                        ...
                                        <div class="value"><?php echo e($parent['selectedChild']->user_id ?? 'N/A'); ?></div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-6">
                                    <div class="info-pill text-center">
                                        ...
                                        <div class="value"><?php echo e($parent['selectedChild']->year_level ?? 'Not Set'); ?></div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-6">
                                    <div class="info-pill text-center">
                                        ...
                                        ?>
                                        <?php if($childSection): ?>
                                            <div class="value"><?php echo e($childSection->name); ?></div>
                                            <?php if($childSection->adviser): ?>
                                                <small class="opacity-75" style="font-size: 0.7rem; text-transform: none;">Adviser: <?php echo e($childSection->adviser->full_name ?? 'TBA'); ?></small>
                                            <?php endif; ?>
                                        <?php else: ?>
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="info-pill text-center">
                                        ...
                                        ?>
                                        <div class="value"><?php echo e(number_format($avgGrade, 1)); ?>%</div>
                                    </div>
                                </div>
                            </div>
                            <div class="row g-3 mt-2">
                                <div class="col-md-3 col-6">
                                    <a href="<?php echo e(route('parent.child.hub', ['childId' => $parent['selectedChild']->id, 'tab' => 'overview'])); ?>" class="btn btn-light w-100">
                                        <i class="fas fa-home me-1"></i> Child Portal
                                    </a>
                                </div>
                                <div class="col-md-3 col-6">
                                    <a href="<?php echo e(route('parent.child.hub', ['childId' => $parent['selectedChild']->id, 'tab' => 'grades'])); ?>" class="btn btn-light w-100">
                                        <i class="fas fa-clipboard-list me-1"></i> Grades
                                    </a>
                                </div>
                                <div class="col-md-3 col-6">
                                    <a href="<?php echo e(route('parent.child.hub', ['childId' => $parent['selectedChild']->id, 'tab' => 'attendance'])); ?>" class="btn btn-light w-100">
                                        <i class="fas fa-user-check me-1"></i> Attendance
                                    </a>
                                </div>
                                <div class="col-md-3 col-6">
                                    <a href="<?php echo e(route('parent.child.hub', ['childId' => $parent['selectedChild']->id, 'tab' => 'feedback'])); ?>" class="btn btn-light w-100">
    ...
    <div class="row mb-4">
        <div class="col-xl-3 col-md-6 mb-4 mb-xl-0">
            <div class="stat-card stat-card-attendance">
                ...
                <div class="stat-content">
                    <h3><?php echo e($parent['attendanceStats']->present_count ?? 0); ?><span class="stat-total">/<?php echo e($parent['attendanceStats']->total_records ?? 0); ?></span></h3>
                    ...
                    <div class="stat-percentage">
                        <?php
                            $attendancePercent = ($parent['attendanceStats']->total_records ?? 0) > 0 
                                ...
                                : 0;
                        ?>
                        <span class="<?php echo e($attendancePercent >= 90 ? 'text-success' : ($attendancePercent >= 75 ? 'text-warning' : 'text-danger')); ?>">
                            <?php echo e($attendancePercent); ?>%
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4 mb-xl-0">
            <div class="stat-card stat-card-subjects">
                ...
                <div class="stat-content">
                    <h3><?php echo e($parent['enrollments'] ? $parent['enrollments']->count() : 0); ?></h3>
        ...
        <div class="col-xl-3 col-md-6 mb-4 mb-md-0">
            <div class="stat-card stat-card-grades">
                ...
                <div class="stat-content">
                    <h3><?php echo e(number_format($avgGrade ?? 0, 1)); ?>%</h3>
                    <p>Average Grade</p>
                    <div class="stat-percentage">
                        <span class="<?php echo e($avgGrade >= 90 ? 'text-success' : ($avgGrade >= 75 ? 'text-info' : 'text-warning')); ?>">
                            <?php echo e($avgGrade >= 90 ? 'Excellent' : ($avgGrade >= 75 ? 'Good' : 'Needs Support')); ?>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card stat-card-activities">
                ...
                <div class="stat-content">
                    <h3><?php echo e($parent['activities'] ? $parent['activities']->count() : 0); ?></h3>
    ...
    <?php if($parent['enrollments'] && $parent['enrollments']->count() > 0): ?>
    <div class="row mb-4">
        <div class="col-12">
            <div class="card modern-card">
                <div class="card-header">
                    <h5 class="card-title">
                        <i class="fas fa-book-open me-2"></i><?php echo e($parent['selectedChild']->first_name); ?>'s Subjects
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <?php $__currentLoopData = $parent['enrollments']->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="subject-card">
                                    <div class="subject-header">
                                        <h6 class="mb-0"><?php echo e($enrollment->subject->subject_name); ?></h6>
                                        <span class="subject-code"><?php echo e($enrollment->subject->subject_id); ?></span>
                                    </div>
                                    <div class="subject-body">
                                        <div class="subject-stat">
                                            <i class="fas fa-chart-line text-primary"></i>
                                            <span>Average: <strong><?php echo e(number_format($subjectAvg, 1)); ?>%</strong></span>
                                        </div>
                                        <div class="subject-stat">
                                            <i class="fas fa-tasks text-success"></i>
                                            <span>Status: <strong class="text-success"><?php echo e(ucfirst($enrollment->status)); ?></strong></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php if($parent['enrollments']->count() > 6): ?>
                        <div class="text-center mt-4">
                            <p class="text-muted mb-0">
                                <i class="fas fa-info-circle me-1"></i>
                                Showing 6 of <?php echo e($parent['enrollments']->count()); ?> subjects
                            </p>
                        </div>
                    <?php endif; ?>
                </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-6">
            <div class="card modern-card">
                ...
                <div class="card-body">
                    <?php if($parent['grades'] && $parent['grades']->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $parent['grades']->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <span class="fw-semibold"><?php echo e($grade->subject->subject_name ?? 'N/A'); ?></span>
                                            </td>
                                            <td>
                                                <span class="badge grade-badge grade-<?php echo e($grade->percentage >= 90 ? 'excellent' : ($grade->percentage >= 75 ? 'good' : 'needs-improvement')); ?>">
                                                    <?php echo e(number_format($grade->percentage, 1)); ?>%
                                                </span>
                                            </td>
                                            <td>
                                                <span class="badge bg-<?php echo e($grade->percentage >= 75 ? 'success' : 'warning'); ?>">
                                                    <?php echo e($grade->percentage >= 75 ? 'Passing' : 'Needs Attention'); ?>

                                                </span>
                                            </td>
                                            <td class="text-muted small">
                                                <?php echo e(\Carbon\Carbon::parse($grade->created_at)->format('M d, Y')); ?>
                        ...
                        <?php if($parent['grades']->count() > 5): ?>
                            <div class="text-center mt-3">
                                <a href="<?php echo e(route('parent.child.hub', ['childId' => $parent['selectedChild']->id, 'tab' => 'grades'])); ?>" class="btn btn-sm btn-outline-primary">
        ...
        <div class="col-lg-6">
            <div class="card modern-card">
                ...
                <div class="card-body">
                    <?php if($parent['attendanceStats'] && ($parent['attendanceStats']->total_records ?? 0) > 0): ?>
                            ...
                            <div class="attendance-circle mb-4">
                                <svg width="200" height="200" viewBox="0 0 200 200" class="mx-auto d-block">
                                    ...
                                    <circle cx="100" cy="100" r="80" fill="none" stroke="#10b981" stroke-width="20"
                                            stroke-dasharray="<?php echo e(2 * 3.14159 * 80); ?>"
                                            stroke-dashoffset="<?php echo e(2 * 3.14159 * 80 * (1 - $attendancePercent / 100)); ?>"
                                            transform="rotate(-90 100 100)"
                                            style="transition: stroke-dashoffset 1s ease;"/>
                                    <text x="100" y="95" text-anchor="middle" font-size="36" font-weight="bold" fill="#333"><?php echo e($attendancePercent); ?>%</text>
                            ...
                            <div class="row g-3 text-center">
                                <div class="col-4">
                                    <div class="attendance-stat">
                                        <h4 class="text-success mb-0"><?php echo e($parent['attendanceStats']->present_count ?? 0); ?></h4>
                                        <small class="text-muted">Present</small>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="attendance-stat">
                                        <h4 class="text-danger mb-0"><?php echo e(($parent['attendanceStats']->total_records ?? 0) - ($parent['attendanceStats']->present_count ?? 0)); ?></h4>
                                        <small class="text-muted">Absent</small>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="attendance-stat">
                                        <h4 class="text-info mb-0"><?php echo e($parent['attendanceStats']->total_records ?? 0); ?></h4>
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-6">
            <div class="card modern-card">
                ...
                <div class="card-body">
                    <?php if($parent['activities'] && $parent['activities']->count() > 0): ?>
                        <div class="activity-list">
                            <?php $__currentLoopData = $parent['activities']->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $dueDate = \Carbon\Carbon::parse($activity->due_date);
                                    $isOverdue = $dueDate->isPast();
                                    $daysUntilDue = $dueDate->diffInDays(now(), false);
                                ?>
                                <div class="activity-item <?php echo e($isOverdue ? 'overdue' : ''); ?>">
                                    <div class="activity-icon">
                                        <i class="fas <?php echo e($isOverdue ? 'fa-exclamation-triangle' : 'fa-clipboard-list'); ?>"></i>
                                    </div>
                                    <div class="activity-details">
                                        <h6 class="mb-1"><?php echo e($activity->title); ?></h6>
                                        <p class="mb-1 text-muted small">
                                            <i class="fas fa-book me-1"></i><?php echo e($activity->lesson->subject->subject_name ?? 'N/A'); ?>

                                        </p>
                                        <p class="mb-0 small">
                                            <i class="fas fa-clock me-1 <?php echo e($isOverdue ? 'text-danger' : 'text-warning'); ?>"></i>
                                            <?php echo e($isOverdue ? 'Overdue by ' . abs($daysUntilDue) . ' days' : 'Due in ' . $daysUntilDue . ' days'); ?>
                                    ...
                                    <div class="activity-status">
                                        ...
                                        <?php else: ?>
                                            <span class="badge <?php echo e($isOverdue ? 'bg-danger' : 'bg-warning'); ?>">
                        ...
                        <?php if($parent['activities']->count() > 5): ?>
                            <div class="text-center mt-3">
                                <p class="text-muted mb-0 small">
                                    <i class="fas fa-info-circle me-1"></i>
                                    Showing 5 of <?php echo e($parent['activities']->count()); ?> activities
                                </p>
                            </div>
                        <?php endif; ?>
                    <?php else: ?>
        ...
        <div class="col-lg-6">
            <div class="card modern-card">
                ...
                <div class="card-body">
                    <?php if($parent['lessons'] && $parent['lessons']->count() > 0): ?>
                        <div class="lesson-list">
                            <?php $__currentLoopData = $parent['lessons']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="lesson-item">
                                    ...
                                    <div class="lesson-details">
                                        ...
                                        <p class="mb-0 text-muted small">
                                            <i class="fas fa-book me-1"></i><?php echo e($lesson->subject->subject_name ?? 'N/A'); ?>

                                        </p>
                                    </div>
                                    <div class="lesson-date">
                                        <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($lesson->created_at)->format('M d')); ?></small>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
        ...
        <div class="col-12">
            <div class="card modern-card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4 g-3">
                        <div class="col-md-4">
                            <div class="info-pill text-center" style="background: rgba(59, 130, 246, 0.1);">
                                ...
                                <div class="value text-primary"><?php echo e($enrollmentApplication->application_number); ?></div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="info-pill text-center" style="background: rgba(245, 158, 11, 0.1);">
                                ...
                                <div class="value text-warning"><?php echo e($enrollmentApplication->documents->count()); ?>/6</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center mt-4">
                        <button type="button" class="btn btn-primary btn-lg shadow-sm" data-bs-toggle="modal" data-bs-target="#enrollmentModal<?php echo e($enrollmentApplication->id); ?>" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none;">
    ...
    <div class="modal fade" id="enrollmentModal<?php echo e($enrollmentApplication->id); ?>" tabindex="-1" aria-labelledby="enrollmentModalLabel<?php echo e($enrollmentApplication->id); ?>" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none;">
                    <h5 class="modal-title fw-bold" id="enrollmentModalLabel<?php echo e($enrollmentApplication->id); ?>">
                        <i class="fas fa-file-alt me-2"></i>Enrollment Application Details - <?php echo e($parent['selectedChild']->first_name); ?> <?php echo e($parent['selectedChild']->last_name); ?>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="alert alert-<?php echo e($enrollmentApplication->status === 'approved' ? 'success' : ($enrollmentApplication->status === 'rejected' ? 'danger' : 'info')); ?> border-0 shadow-sm">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h6 class="mb-2 fw-bold"><i class="fas fa-info-circle me-2"></i>Application Status</h6>
                                <p class="mb-1">
                                    <strong>Status:</strong> 
                                    <span class="badge bg-<?php echo e($enrollmentApplication->status === 'approved' ? 'success' : ($enrollmentApplication->status === 'rejected' ? 'danger' : 'warning')); ?> fs-6">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $enrollmentApplication->status))); ?>
                                ...
                                <div class="col-md-6">
                                    <table class="table table-borderless table-sm">
                                        <tr>
                                            ...
                                            <td class="fw-semibold"><?php echo e($enrollmentApplication->full_name); ?></td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="col-md-6">
                                    <table class="table table-borderless table-sm">
                                        <tr>
                                            ...
                                            <td class="fw-semibold"><?php echo e($enrollmentApplication->parent_name); ?></td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold text-muted">Email:</td>
                    ...
                    <div class="card mb-3 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="mb-1"><span class="fw-bold text-muted">Name:</span> <?php echo e($enrollmentApplication->emergency_contact_name ?? 'N/A'); ?></p>
                                </div>
                                <div class="col-md-6">
                                    <p class="mb-1"><span class="fw-bold text-muted">Phone:</span> <?php echo e($enrollmentApplication->emergency_contact_phone ?? 'N/A'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3 border-0 shadow-sm">
                        <div class="card-header text-white" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); border: none;">
                            <h6 class="mb-0 fw-bold"><i class="fas fa-file-upload me-2"></i>Uploaded Documents (<?php echo e($enrollmentApplication->documents->count()); ?>/6)</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $enrollmentApplication->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td class="fw-semibold"><?php echo e(\App\Models\EnrollmentDocument::DOCUMENT_TYPES[$doc->document_type] ?? ucfirst(str_replace('_', ' ', $doc->document_type))); ?></td>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-<?php echo e($doc->status === 'verified' ? 'success' : ($doc->status === 'rejected' ? 'danger' : 'warning')); ?>">
                                                            <i class="fas fa-<?php echo e($doc->status === 'verified' ? 'check' : ($doc->status === 'rejected' ? 'times' : 'clock')); ?> me-1"></i>
                                                            <?php echo e(ucfirst($doc->status)); ?>

                                                        </span>
                                                    </td>
                                                    <td class="text-muted"><?php echo e($doc->created_at->format('M d, Y')); ?></td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                                    </table>
                        ...
                        <?php if($subjects): ?>
                            <div class="card border-0 shadow-sm">
                                <div class="card-header text-white" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border: none;">
                                    <h6 class="mb-0 fw-bold"><i class="fas fa-book me-2"></i>Subjects for <?php echo e($enrollmentApplication->grade_level_applying_for); ?></h6>
                                </div>
                                <div class="card-body">
                                    <div class="row g-2">
...
function switchChild(childId) {
    if (childId) {
        window.location.href = '<?php echo e(url("/parent/child")); ?>/' + childId + '?tab=overview';
    }
}
</script>
<?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views/partials/parent_dashboard.blade.php ENDPATH**/ ?>