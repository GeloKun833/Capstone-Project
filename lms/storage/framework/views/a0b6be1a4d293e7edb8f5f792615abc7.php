...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
                    ...
                    <div class="card bg-primary text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h4 class="mb-0"><?php echo e($analytics['performance_indicators']['average_score']); ?>%</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h4 class="mb-0"><?php echo e($analytics['performance_indicators']['total_assignments']); ?></h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card bg-warning text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h4 class="mb-0"><?php echo e($analytics['performance_indicators']['excellent_grades_count']); ?></h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h4 class="mb-0"><?php echo e($analytics['performance_indicators']['performance_level']); ?></h4>
                ...
                <div class="col-12">
                    <div class="card card-table">
                        <div class="card-body">
                            ...
                            <?php if(count($analytics['subject_performance']) > 0): ?>
                                <div class="table-responsive">
                                    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $analytics['subject_performance']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a><?php echo e($subject['subject']); ?></a>
                                                        </h2>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-success"><?php echo e($subject['highest_score']); ?>%</span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-danger"><?php echo e($subject['lowest_score']); ?>%</span>
                                                    </td>
                                                    <td>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $analytics['recent_activities']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a><?php echo e($activity['activity']); ?></a>
                                                        </h2>
                                                    </td>
                                                    <td><?php echo e($activity['subject']); ?></td>
                                                    <td><?php echo e($activity['submitted_at']); ?></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <?php if($activity['score'] !== '-'): ?>
                                                            <strong><?php echo e($activity['score']); ?></strong>
                                                        <?php else: ?>
            ...
            <!-- Performance Alerts -->
            <?php if($analytics['performance_indicators']['improvement_needed']): ?>
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-warning">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">You have <?php echo e($analytics['performance_indicators']['low_grades_count']); ?> assignment(s) with scores below 75%. Consider reviewing these subjects and seeking additional help if needed.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
function initializeCharts() {
    ...
    gradeTrendsChart = new Chart(gradeCtx, {
        type: 'line',
        data: {
            labels: <?php echo json_encode(collect($analytics['grade_trends'])->pluck('period')); ?>,
            datasets: [{
                label: 'Grade Score (%)',
                data: <?php echo json_encode(collect($analytics['grade_trends'])->pluck('score')); ?>,
                borderColor: '#3d5ee1',
    ...
    attendanceChart = new Chart(attendanceCtx, {
        type: 'bar',
        data: {
            labels: <?php echo json_encode(collect($analytics['attendance_summary'])->pluck('month')); ?>,
            datasets: [{
                label: 'Attendance Rate (%)',
                data: <?php echo json_encode(collect($analytics['attendance_summary'])->pluck('percentage')); ?>,
                backgroundColor: [
                    '#7bb13c',
                    '#3d5ee1',
                    '#ffc107',
    ...
    subjectPerformanceChart = new Chart(subjectCtx, {
        type: 'bar',
        data: {
            labels: <?php echo json_encode(collect($analytics['subject_performance'])->pluck('subject')); ?>,
            datasets: [{
                label: 'Average Score (%)',
                data: <?php echo json_encode(collect($analytics['subject_performance'])->pluck('average_score')); ?>,
                backgroundColor: [
                    '#3d5ee1',
                    '#7bb13c',
                    '#ffc107',
...
function applyFilters() {
    ...
    window.location.href = '<?php echo e(route("analytics.student-dashboard")); ?>?' + params.toString();
}
