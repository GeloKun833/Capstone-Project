        ...
        <div class="content container-fluid dir-page">
            ...
            <div class="page-header">
                <div class="row align-items-start">
                    <div class="col">
                        <h3 class="page-title mb-1">Mark Attendance</h3>
                        <p class="dir-subtitle">Record who was present or absent for a class day.</p>
                    </div>
                    ...
                    <div class="dir-card">
                        <div class="p-3 p-md-4">
                            <div class="d-flex justify-content-end mb-3">
                                <button type="submit" form="attendanceForm" class="btn btn-primary dir-btn">
...
$(document).ready(function() {
    ...
    // Auto-load students when subject changes (section is optional)
    $('#subject_id, #section_id, #date').on('change', function() {
    ...
    $('#attendanceForm').on('submit', function(e) {
        ...
        if (!subjectId || !date) {
            e.preventDefault();
            alert('Please select Subject and Date before saving attendance.');
            return false;
        }
