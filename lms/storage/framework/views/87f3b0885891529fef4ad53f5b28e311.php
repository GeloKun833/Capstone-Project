    ...
    <div class="col-lg-6">
        <div class="ep-card h-100">
            ...
            <div class="ep-card-body">
                ...
                <a href="<?php echo e(route('enrollment.portal.status')); ?>" class="ep-btn ep-btn-primary ep-btn-block">
        ...
        <div class="ep-card h-100">
            ...
            <div class="ep-card-body">
                <div class="ep-process-list">
                    <?php $__currentLoopData = ['Select your enrollment type','Complete the application form','Upload required documents','Wait for registrar approval','Receive your login credentials']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="ep-process-item">
                        <div class="ep-process-num"><?php echo e($i + 1); ?></div>
        ...
        <div class="row g-4">
            <div class="col-md-6">
                ...
                <ul class="list-unstyled">
                    <?php $__currentLoopData = ['Birth Certificate','SF10 (Report Card)','Certificate of Good Moral Character','ID Photo (2×2)','Parent/Guardian ID','SF9 (Transferees only)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i><?php echo e($doc); ?></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
            <div class="col-md-6">
...
<?php echo $__env->make('layouts.enrollment-portal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views/enrollment/portal/index.blade.php ENDPATH**/ ?>