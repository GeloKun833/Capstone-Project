...
<div class="container py-4">
    ...
    <form method="GET" action="<?php echo e(route('attendance.parent')); ?>" class="row g-3 mb-4">
        <div class="col-md-3">
            <label for="student_id" class="form-label">Child</label>
            <select name="student_id" id="student_id" class="form-select">
                <option value="">Select Child</option>
                <?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($child->id); ?>" <?php echo e(request('student_id') == $child->id ? 'selected' : ''); ?>>
                        <?php echo e($child->first_name); ?> <?php echo e($child->last_name); ?>
    ...
    <?php if($selectedStudent): ?>
        <div class="alert alert-info">
            Showing attendance for: <?php echo e($selectedStudent->first_name); ?> <?php echo e($selectedStudent->last_name); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\attendance\parent_view.blade.php ENDPATH**/ ?>