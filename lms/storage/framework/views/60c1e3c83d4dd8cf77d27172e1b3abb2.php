                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(route('academic_years.index')); ?>">Academic Years</a></li>
                ...
                <div class="col-sm-12">
                    <div class="card card-table">
                        <div class="card-body">
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="<?php echo e(route('academic_years.index')); ?>" class="btn btn-outline-secondary me-2">
                            ...
                            <form action="<?php echo e(route('academic_years.update', $academicYear)); ?>" method="POST" id="academicYearForm">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e(old('name', $academicYear->name)); ?>" placeholder="e.g., 2024-2025" required>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="code" name="code" value="<?php echo e(old('code', $academicYear->code ?? '')); ?>" placeholder="e.g., AY2024-25">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
...
unset($__errorArgs, $__bag); ?>" id="start_date" name="start_date" value="<?php echo e(old('start_date', $academicYear->start_date)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="end_date" name="end_date" value="<?php echo e(old('end_date', $academicYear->end_date)); ?>" required>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Optional description for this academic year"><?php echo e(old('description', $academicYear->description ?? '')); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="is_active" name="is_active">
                                                    <option value="1" <?php echo e(old('is_active', $academicYear->is_active ?? '1') == '1' ? 'selected' : ''); ?>>Active</option>
                                                    <option value="0" <?php echo e(old('is_active', $academicYear->is_active ?? '1') == '0' ? 'selected' : ''); ?>>Inactive</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="info-item">
                                                            ...
                                                            <span class="info-value"><?php echo e($academicYear->created_at ? \Carbon\Carbon::parse($academicYear->created_at)->format('M d, Y H:i') : 'N/A'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="info-item">
                                                            <label class="info-label">Last Updated:</label>
                                                            <span class="info-value"><?php echo e($academicYear->updated_at ? \Carbon\Carbon::parse($academicYear->updated_at)->format('M d, Y H:i') : 'N/A'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="info-item">
                                                            <label class="info-label">Record ID:</label>
                                                            <span class="info-value">#<?php echo e($academicYear->id); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php $__env->stopSection(); ?> <?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\academic_years\edit.blade.php ENDPATH**/ ?>