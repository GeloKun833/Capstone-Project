                    ...
                    <div class="col">
                        <ul class="breadcrumb invoices-breadcrumb">
                            <li class="breadcrumb-item invoices-breadcrumb-item">
                                <a href="<?php echo e(route('invoice/list/page')); ?>">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card invoices-add-card">
                        <div class="card-body">
                            <form action="<?php echo e(route('invoice/update/save')); ?>" class="invoices-form" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="invoice_id" value="<?php echo e($invoiceView->invoice_id); ?>">
...
unset($__errorArgs, $__bag); ?>" style="width: 100%;" tabindex="-1" aria-hidden="true" id="customer_name" name="customer_name">
                                                    <option><?php echo e($invoiceView->customer_name); ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="po_number" name="po_number" value="<?php echo e($invoiceView->po_number); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-5 col-md-6 col-sm-12 col-12">
                                            ...
                                            <div class="invoice-details-box">
                                                <div class="invoice-inner-head">
                                                    <span>Invoice No. <a><?php echo e($invoiceView->invoice_id); ?></a></span>
                                                </div>
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="invoice-inner-date">
                                                                <span>
                                                                    Date <input class="form-control datetimepicker" type="text" name="date" value="<?php echo e(date('d-m-Y')); ?>">
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="invoice-inner-date invoice-inner-datepic">
                                                                <span>
                                                                    Due Date <input class="form-control datetimepicker" type="text" name="due_date" value="<?php echo e($invoiceView->due_date); ?>">
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="inovices-month-info">
                                                <div class="form-group mb-0">
                                                    <label class="custom_check w-100">
                                                        <?php if(!empty($invoiceView->enable_tax)): ?>
                                                    ...
                                                    <label class="custom_check w-100">
                                                        <?php if(!empty($invoiceView->recurring_incoice)): ?>
                                                ...
                                                <div id="show">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <select class="select" id="by_month" name="by_month">
                                                                    <option selected><?php echo e($invoiceView->by_month); ?></option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <input class="form-control" type="text" name="month" value="<?php echo e($invoiceView->month); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-6 col-md-6">
                                            <div class="invoice-info">
                                                ...
                                                <textarea rows="1.5" class="form-control" name="invoice_from"><?php echo e($invoiceView->invoice_from); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-lg-6 col-md-6">
                                            <div class="invoice-info">
                                                <strong class="customer-text">Invoice To</strong>
                                                <textarea rows="1.5" class="form-control" name="invoice_to"><?php echo e($invoiceView->invoice_to); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="invoice-add-table">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-center add-table-items" id="invoice-add-table">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $invoiceDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="add-row">
                                                        <td hidden><input type="text" class="form-control" name="id[]" value="<?php echo e($value->id); ?>"></td>
                                                        <td><input type="text" class="form-control" name="items[]" value="<?php echo e($value->items); ?>"></td>
                                                        <td><input type="text" class="form-control" name="category[]" value="<?php echo e($value->category); ?>"></td>
                                                        <td><input type="text" class="form-control" name="quantity[]" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?php echo e($value->quantity); ?>"></td>
                                                        <td><input type="text" class="form-control price" name="price[]" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?php echo e($value->price); ?>"></td>
                                                        <td><input type="text" class="form-control amount" name="amount[]" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?php echo e($value->amount); ?>" ></td>
                                                        <td><input type="text" class="form-control discount" name="discount[]" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?php echo e($value->discount); ?>"></td>
                                ...
                                <div class="row">
                                    <div class="col-lg-7 col-md-6">
                                        <?php if(empty($invoiceView->account_holder_name)): ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="auto_account_holder_name" name="account_holder_name" placeholder="Add Name" value="<?php echo e($invoiceView->account_holder_name); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        <label>Bank name</label>
                                                        <input type="text" class="form-control" id="auto_bank_name" name="bank_name" placeholder="Add Bank name" value="<?php echo e($invoiceView->bank_name); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        <label>IFSC Code</label>
                                                        <input type="text" class="form-control" id="auto_ifsc_code" name="ifsc_code" placeholder="IFSC Code" value="<?php echo e($invoiceView->ifsc_code); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        <label>Account Number</label>
                                                        <input type="text" class="form-control" id="auto_account_number" name="account_number" placeholder="Account Number" value="<?php echo e($invoiceView->account_number); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-5 col-md-6">
                                        <div class="invoice-total-card">
                                            ...
                                            <div class="invoice-total-box">
                                                <div class="invoice-total-inner">
                                                    <input type="hidden" name="taxable_amount" id="taxable_amount" value="<?php echo e($invoiceView->taxable_amount); ?>">
                                                    <p>Taxable Amount <span id="">$<?php echo e($invoiceView->taxable_amount); ?></span></p>
                                                    <p>Round Off
                                                        <?php if(!empty($invoiceView->round_off)): ?>
                                                            <input type="checkbox" name="round_off" id="status_1" class="check" checked value="<?php echo e($invoiceView->round_off); ?>">
                                                            <label for="status_1" class="checktoggle">checkbox</label>
                                                            <span>$<?php echo e($invoiceView->round_off); ?></span>
                                                        <?php else: ?> 
                                                    ...
                                                    <?php if(!empty($AdditionalCharges)): ?>  
                                                        <?php $__currentLoopData = $AdditionalCharges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="service-amount">
                                                                <a href="#" class="service-trash">
                                                                    <i class="fe fe-minus-circle me-1"></i>Service Charge
                                                                </a> 
                                                                <span>$<?php echo e($value->service_charge); ?></span>
                                                                <input type="hidden" name="service_charge[]" value="<?php echo e($value->service_charge); ?>">
                                                            </div>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php endif; ?>
                                                    ...
                                                    <?php if(!empty($InvoiceDiscount)): ?>  
                                                        <?php $__currentLoopData = $InvoiceDiscount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="service-amount">
                                                                <a href="#" class="service-trash-one">
                                                                    <i class="fe fe-minus-circle me-1"></i> Offer new
                                                                </a>
                                                                <span>$<?php echo e($value->offer_new); ?>%</span>
                                                                <input type="hidden" name="offer_new[]" value="<?php echo e($value->offer_new); ?>">
                                                            </div>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="invoice-total-footer">
                                                    <h4>Total Amount <span id="total_amount">$<span class="total_amount" name="total_amount"><?php echo e($invoiceView->total_amount); ?></span></span></h4>
                                                    <input type="hidden" name="total_amount" value="<?php echo e($invoiceView->total_amount); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="upload-sign">
                                            <div class="form-group service-upload">
                                                ...
                                                <img class="img-fluid d-inline-block" src="<?php echo e(Storage::url($invoiceView->upload_sign)); ?>" alt="sign" style="width: 20%;">
                                                <input type="hidden" name="upload_sign_unlink" value="<?php echo e($invoiceView->upload_sign); ?>">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="name_of_the_signatuaory" placeholder="Name of the Signatuaory" value="<?php echo e($invoiceView->name_of_the_signatuaory); ?>">
                                            </div>
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <div class="invoice-item invoice-item-bg">
                                        <div class="invoice-circle-img">
                                            <img src="<?php echo e(URL::to('assets/img/invoice-circle1.png')); ?>" alt="" class="invoice-circle1">
                                            ...
                                            <div class="col-lg-4 col-md-4">
                                                <div class="invoice-sign text-end">
                                                    <img class="img-fluid d-inline-block"
                                                        src="<?php echo e(URL::to('assets/img/signature.png')); ?>" alt="sign">
                                                    <span class="d-block"><?php echo e(Session::get('name')); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <form action="<?php echo e(route('invoice/delete')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <input type="hidden" name="invoice_id" value="<?php echo e($invoiceView->invoice_id); ?>">
                                <input type="hidden" name="upload_sign" value="<?php echo e($invoiceView->upload_sign); ?>">
                                <div class="col-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\invoices\invoice_edit.blade.php ENDPATH**/ ?>