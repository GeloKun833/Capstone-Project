...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::to('assets/css/modern-datepicker.css')); ?>?v=<?php echo e(filemtime(public_path('assets/css/modern-datepicker.css'))); ?>">
...
<body>
    ...
    <script src="<?php echo e(URL::to('assets/js/modern-datepicker.js')); ?>?v=<?php echo e(filemtime(public_path('assets/js/modern-datepicker.js'))); ?>"></script>
