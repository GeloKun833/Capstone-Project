        ...
        <div class="chat-shell">
            ...
            <aside class="chat-sidebar">
                <div class="chat-sidebar-head">
                    ...
                    <?php elseif(Auth::user()->role_name === 'Registrar'): ?>
                ...
                <div class="contacts-list" id="contacts-list">
                    <?php $__empty_1 = true; $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="contact-group" data-role-group="<?php echo e($role); ?>">
                            <div class="contact-group-title">
                                <?php echo e($roleLabels[$role] ?? $role); ?>

                                <span><?php echo e($items->count()); ?></span>
                            </div>
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $u = $conversation['user']; ?>
                                <div class="contact-item"
                                     data-user-id="<?php echo e($u->id); ?>"
                                     data-user-name="<?php echo e($u->name); ?>"
                                     data-user-avatar="<?php echo e($u->avatar ?? 'default-avatar.png'); ?>"
                                     data-user-role="<?php echo e($u->role_name); ?>"
                                     onclick="loadConversation(<?php echo e($u->id); ?>, '<?php echo e(addslashes($u->name)); ?>', '<?php echo e($u->avatar ?? 'default-avatar.png'); ?>', '<?php echo e($u->role_name); ?>')">
                                    <div class="contact-row">
                                        <div class="contact-avatar-wrap">
                                            <img src="<?php echo e(asset('assets/img/profiles/' . ($u->avatar ?? 'default-avatar.png'))); ?>"
                                        ...
                                        <div class="contact-meta">
                                            <div class="contact-top">
                                                ...
                                                <?php if($conversation['last_message']): ?>
                                                    <small class="last-time"><?php echo e($conversation['last_message']->created_at->diffForHumans(null, true, true)); ?></small>
                                                <?php endif; ?>
                                            </div>
                                            <div class="contact-bottom">
                                                <p class="last-preview">
                                                    <?php echo e($conversation['last_message']->content ?? 'No messages yet'); ?>
                                            ...
                                            <span class="chat-role-badge <?php echo e($roleBadge[$u->role_name] ?? 'chat-role-default'); ?>"><?php echo e($u->role_name); ?></span>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    const initialReceiverId = <?php echo e((int) ($receiverId ?? 0)); ?>;
    ...
    function loadConversation(userId, userName, userAvatar, userRole) {
        ...
        $('#contact-avatar').attr('src', '<?php echo e(asset("assets/img/profiles/")); ?>/' + (userAvatar || 'default-avatar.png'));
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views/chat/index.blade.php ENDPATH**/ ?>