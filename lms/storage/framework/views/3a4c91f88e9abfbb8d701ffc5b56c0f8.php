                        ...
                        <div class="col-md-12">
                            ...
                            <div class="student-profile-head">
                                <div class="profile-bg-img">
                                    <img src="<?php echo e(URL::to('assets/img/profile-bg.jpg')); ?>" alt="Profile">
                                </div>
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                        <div class="profile-user-box">
                                            <div class="profile-user-img">
                                                <img src="<?php echo e(Storage::url('student-photos/'.$studentProfile->upload)); ?>" alt="Profile">
                                            ...
                                            <div class="names-profiles">
                                                <h4><?php echo e($studentProfile->first_name); ?> <?php echo e($studentProfile->last_name); ?></h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="personal-activity">
                                            ...
                                            <div class="views-personal">
                                                <h4>Name</h4>
                                                <h5><?php echo e($studentProfile->first_name); ?> <?php echo e($studentProfile->last_name); ?></h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                            <div class="personal-icons">
                                                <img src="<?php echo e(URL::to('assets/img/icons/buliding-icon.svg')); ?>" alt="">
                                            </div>
                                            <div class="views-personal">
                                                <h4>Department </h4>
                                                <h5>Computer Science</h5>
                                        ...
                                        <div class="personal-activity">
                                            ...
                                            <div class="views-personal">
                                                <h4>Mobile</h4>
                                                <h5><?php echo e($studentProfile->phone_number); ?></h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                            <div class="personal-icons">
                                            ...
                                            <div class="views-personal">
                                                <h4>Email</h4>
                                                <h5><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="81e5e0e8f2f8c1e6ece0e8edafe2eeec"><?php echo e($studentProfile->email); ?></a>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                            ...
                                            <div class="views-personal">
                                                <h4>Gender</h4>
                                                <h5><?php echo e($studentProfile->gender); ?></h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                            <div class="personal-icons">
                                            ...
                                            <div class="views-personal">
                                                <h4>Date of Birth</h4>
                                                <h5><?php echo e($studentProfile->date_of_birth); ?></h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                            <div class="personal-icons">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\student\student-profile.blade.php ENDPATH**/ ?>