    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="student-group-form">
                <form method="GET" action="<?php echo e(route('subject/list/page')); ?>">
                    <div class="row">
                            ...
                            <div class="form-group">
                                <select name="search_class" class="form-control">
                                    ...
                                    <?php $__currentLoopData = ($gradeLevels ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($grade); ?>" <?php echo e(request('search_class') === $grade ? 'selected' : ''); ?>><?php echo e($grade); ?></option>
                        ...
                        <div class="col-lg-2">
                            <div class="search-student-btn">
                                ...
                                <a href="<?php echo e(route('subject/list/page')); ?>" class="btn btn-secondary">Clear</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views/subjects/subject_list.blade.php ENDPATH**/ ?>