            ...
            <div class="card-body">
                ...
                <p class="text-muted mb-4">
                    ...
                    <?php if($calendarEvent->is_all_day): ?>
                        All day
                    <?php else: ?>
                        <?php echo e($calendarEvent->start_time->format('g:i A')); ?> – <?php echo e($calendarEvent->end_time->format('g:i A')); ?>
                ...
                <?php endif; ?>
                <?php if($calendarEvent->subject && $calendarEvent->subject->class): ?>
                    <p><strong>Class:</strong> <?php echo e($calendarEvent->subject->class); ?></p>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\calendar\student-show.blade.php ENDPATH**/ ?>