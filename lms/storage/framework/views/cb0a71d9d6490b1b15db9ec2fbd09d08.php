                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <select class="form-control form-control-sm" id="filter_room">
                            ...
                            <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($room->id); ?>"><?php echo e($room->full_name ?? $room->room_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
(function () {
    ...
    const ROUTES = {
        ...
        update: '<?php echo e(url("/calendar")); ?>',
        destroy: '<?php echo e(url("/calendar")); ?>',
        slots: '<?php echo e(route("calendar.available-slots")); ?>',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views/calendar/index.blade.php ENDPATH**/ ?>