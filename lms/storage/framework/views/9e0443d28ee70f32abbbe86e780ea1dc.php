            ...
            <div class="row">
                <div class="col-xl-3 col-md-4">
                    <div class="widget settings-menu">
                        <ul>
                            <li class="nav-item">
                                <a href="<?php echo e(route('setting/page')); ?>" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('invoice/settings/bank/page')); ?>" class="nav-link active">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\invoices\settings\settings_bank.blade.php ENDPATH**/ ?>