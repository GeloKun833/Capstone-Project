                ...
                <div class="profile-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto profile-btn">
                            <a href="<?php echo e(route('user/profile/edit')); ?>" class="btn btn-primary">Edit</a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title d-flex justify-content-between">
                                                ...
                                                <a class="edit-link" href="<?php echo e(route('user/profile/edit')); ?>"><i
                                            ...
                                            <div class="row">
                                                ...
                                                <p class="col-sm-9"><?php echo e(Session::get('email')); ?></p>
                                            </div>
                                            <div class="row">
                                                <p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Mobile</p>
                                                <p class="col-sm-9"><?php echo e(Session::get('phone_number') ?? 'N/A'); ?></p>
                                            </div>
                                            <div class="row">
                                                <p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Position</p>
                                                <p class="col-sm-9"><?php echo e(Session::get('position')); ?></p>
                                            </div>
                                            <div class="row">
                                                <p class="col-sm-3 text-muted text-sm-end mb-0">Department</p>
                                                <p class="col-sm-9 mb-0"><?php echo e(Session::get('department')); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <button class="btn btn-success" type="button"><i class="fe fe-check-verified"></i> <?php echo e(Session::get('user_status')); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
