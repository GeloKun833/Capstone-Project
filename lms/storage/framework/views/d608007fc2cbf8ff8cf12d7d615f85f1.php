                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <p class="text-muted">Create a new activity for lesson: <strong><?php echo e($lesson->title); ?></strong></p>
                                    </div>
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="<?php echo e(route('lessons.activities.index', $lesson)); ?>" class="btn btn-outline-secondary me-2">
...
unset($__errorArgs, $__bag); ?>" id="title" name="title" value="<?php echo e(old('title')); ?>" placeholder="Enter activity title" required>
...
unset($__errorArgs, $__bag); ?>" id="due_date" name="due_date" value="<?php echo e(old('due_date', now()->addDays(7)->toDateString())); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="instructions" name="instructions" rows="4" placeholder="Provide detailed instructions for students on how to complete this activity" required><?php echo e(old('instructions')); ?></textarea>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="allows_submission" name="allows_submission" value="1" <?php echo e(old('allows_submission') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="info-item">
                                                            ...
                                                            <span class="info-value"><?php echo e($lesson->title); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="info-item">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="info-item">
                                                            ...
                                                            <span class="info-value"><?php echo e($lesson->section->name); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="info-item">
                                                            <label class="info-label">Lesson Date:</label>
                                                            <span class="info-value"><?php echo e($lesson->lesson_date->format('M d, Y')); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
