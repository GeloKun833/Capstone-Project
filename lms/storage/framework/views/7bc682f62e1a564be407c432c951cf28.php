        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Add Academic Year</h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="card card-table">
                        <div class="card-body">
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h3 class="page-title">Academic Year Information</h3>
                                    </div>
                            ...
                            <form action="<?php echo e(route('academic_years.store')); ?>" method="POST" id="academicYearForm">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="e.g., 2024-2025" required>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="code" name="code" value="<?php echo e(old('code')); ?>" placeholder="e.g., AY2024-25">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Optional description for this academic year"><?php echo e(old('description')); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
...
$(document).ready(function() {
    ...
    // Auto-set end date to one year after start date
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\academic_years\create.blade.php ENDPATH**/ ?>