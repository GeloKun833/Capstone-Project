                ...
                <div class="card ams-par-card mb-3">
                    <div class="card-body py-3">
                        <div class="row g-2 align-items-end">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control form-control-sm" id="filter_child">
                                        ...
                                        <?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($child->id); ?>" <?php echo e((int) $selectedChildId === (int) $child->id ? 'selected' : ''); ?>>
                            ...
                            <?php else: ?>
                                <input type="hidden" id="filter_child" value="<?php echo e($children->first()->id ?? ''); ?>">
                            <?php endif; ?>
                            <div class="<?php echo e($showChildSelector ? 'col-md-3' : 'col-md-4'); ?>">
                ...
                <div class="ams-par-legend mb-3">
                    <?php $__currentLoopData = $typeColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="ams-par-legend-item">
                            <span class="ams-par-dot" style="background:<?php echo e($color); ?>"></span>
                    ...
                    <div class="card-body p-0">
                        <?php $__empty_1 = true; $__currentLoopData = $upcomingEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <button type="button"
                                ...
                                data-type="<?php echo e($event->event_type); ?>"
                                data-start="<?php echo e($event->start_time->toIso8601String()); ?>"
                                data-end="<?php echo e($event->end_time->toIso8601String()); ?>"
                                data-all-day="<?php echo e($event->is_all_day ? 1 : 0); ?>"
                                data-subject="<?php echo e($event->subject?->subject_name); ?>"
                                data-teacher="<?php echo e($event->teacher?->full_name); ?>"
                                data-room="<?php echo e($event->room?->full_name ?? $event->room?->room_name); ?>"
                                data-description="<?php echo e($event->description); ?>"
                                data-recurring="<?php echo e($event->is_recurring ? 1 : 0); ?>"
                                data-pattern="<?php echo e($event->recurrence_pattern); ?>"
                                data-until="<?php echo e(optional($event->recurrence_end_date)?->format('Y-m-d')); ?>">
                                <div class="ams-upcoming-date">
                                    <?php if($event->start_time->isToday()): ?>
                                        Today
                                    <?php elseif($event->start_time->isTomorrow()): ?>
                                        Tomorrow
                                    <?php else: ?>
                                        <?php echo e($event->start_time->format('M j')); ?>

                                    <?php endif; ?>
                                </div>
                                <div class="ams-upcoming-title"><?php echo e($event->title); ?></div>
                                <div class="ams-upcoming-time">
                                    <?php if($event->is_all_day): ?>
                                        All day
                                    <?php else: ?>
                                        <?php echo e($event->start_time->format('g:i A')); ?>
...
(function () {
    ...
    const MULTI_CHILD = <?php echo json_encode($showChildSelector, 15, 512) ?>;
    let calendar = null;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\calendar\parent.blade.php ENDPATH**/ ?>