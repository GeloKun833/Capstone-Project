    ...
    <div class="content container-fluid ams-semesters">
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto d-flex flex-wrap gap-2">
                    <a href="<?php echo e(route('academic_years.index')); ?>" class="btn btn-outline-secondary">
                    ...
                    <button type="button" class="btn btn-primary" id="btnAddSemester"
                        ...
                        <?php if($academicYears->isEmpty()): ?> disabled <?php endif; ?>>
        ...
        <?php if($academicYears->isEmpty()): ?>
            <div class="alert alert-warning">
                Create an <a href="<?php echo e(route('academic_years.index')); ?>">Academic Year</a> first, then add semesters.
            </div>
        <?php endif; ?>
        ...
        <div class="ams-toolbar mb-3">
            ...
            <div class="ams-filter-bar mt-2">
                ...
                <?php $__currentLoopData = $academicYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button type="button" class="ams-filter-chip" data-year="<?php echo e($year->id); ?>">
        ...
        <div class="row g-3" id="semestersGrid">
            <?php $__empty_1 = true; $__currentLoopData = $semesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-6 col-md-4 col-xl-3 semester-grid-item"
                    ...
                    data-search="<?php echo e(strtolower($semester->name.' '.optional($semester->academicYear)->name)); ?>"
                    ...
                    <button type="button"
                        ...
                        data-year-id="<?php echo e($semester->academic_year_id); ?>"
                        data-year-name="<?php echo e(optional($semester->academicYear)->name ?? '—'); ?>"
                        data-update-url="<?php echo e(route('semesters.update', $semester)); ?>"
                        data-destroy-url="<?php echo e(route('semesters.destroy', $semester)); ?>">
                        <div class="ams-sem-title"><?php echo e($semester->name); ?></div>
                        <div class="ams-sem-year mt-2"><?php echo e(optional($semester->academicYear)->name ?? 'No year'); ?></div>
...
<div id="semestersPageConfig" class="d-none"
    data-store-url="<?php echo e(route('semesters.store')); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views/semesters/index.blade.php ENDPATH**/ ?>