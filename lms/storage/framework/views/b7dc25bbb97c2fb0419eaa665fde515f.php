            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted mb-0">
                        ...
                        <a href="<?php echo e(route('class-subject.unified-management')); ?>">Classes &amp; Subjects</a>
                ...
                <div class="col-auto d-flex flex-wrap gap-2">
                    <form action="<?php echo e(route('curriculum.syncAll')); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
        ...
        <div class="row g-3" id="curriculumGrid">
            <?php $__currentLoopData = $curricula; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $curriculum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-6 col-md-4 col-xl-3 curriculum-grid-item"
                    data-search="<?php echo e(strtolower($curriculum->grade_level.' '.$names.' '.($curriculum->description ?: ''))); ?>">
                    <button type="button"
                        class="ams-curr-card w-100 text-start"
                        data-bs-toggle="modal"
                        data-bs-target="#curriculumModal"
                        data-id="<?php echo e($curriculum->id); ?>"
                        data-grade="<?php echo e($curriculum->grade_level); ?>"
                        data-description="<?php echo e($curriculum->description ?: ''); ?>"
                        data-linked="<?php echo e($linkedCount); ?>"
                        data-catalog="<?php echo e($catalogCount); ?>"
                        data-assign-url="<?php echo e(route('curriculum.assignSubjectsForm', $curriculum)); ?>"
                        data-sync-url="<?php echo e(route('curriculum.syncFromCatalog', $curriculum)); ?>"
                        data-update-url="<?php echo e(route('curriculum.update', $curriculum)); ?>"
                        data-destroy-url="<?php echo e(route('curriculum.destroy', $curriculum)); ?>">
                        <div class="d-flex justify-content-between align-items-start gap-2">
                            <span class="ams-curr-title"><?php echo e($curriculum->grade_level); ?></span>
                            <span class="ams-curr-count <?php echo e($linkedCount ? '' : 'is-empty'); ?>"><?php echo e($linkedCount); ?></span>
                        </div>
                        <div class="ams-curr-meta mt-2">
                            <?php if($linkedCount === 0): ?>
                                <span class="text-muted">No subjects linked — click to sync</span>
                            <?php else: ?>
                                <span class="text-muted"><?php echo e($preview); ?><?php if($linkedCount > 3): ?>…<?php endif; ?></span>
                            <?php endif; ?>
                        </div>
                        <div class="ams-curr-status mt-2">
                            <?php if($inSync): ?>
                                <span class="ams-pill ams-pill--ok"><i class="fas fa-link me-1"></i>In sync with catalog</span>
                            <?php elseif($catalogCount === 0): ?>
                                <span class="ams-pill ams-pill--warn"><i class="fas fa-exclamation me-1"></i>Add subjects in catalog</span>
                            <?php else: ?>
                                <span class="ams-pill ams-pill--info"><i class="fas fa-sync me-1"></i>Catalog has <?php echo e($catalogCount); ?></span>
                            <?php endif; ?>
                        </div>
...
<?php
    $subjectsByIdJson = $curricula->mapWithKeys(function ($c) {
        return [
...
(function () {
    ...
    const subjectsById = <?php echo json_encode($subjectsByIdJson, 15, 512) ?>;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\curriculum\index.blade.php ENDPATH**/ ?>