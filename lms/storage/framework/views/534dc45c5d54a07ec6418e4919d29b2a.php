            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-4 text-sm-end mt-2 mt-sm-0">
                        <a href="<?php echo e(route('teacher.my-schedule')); ?>" class="btn btn-outline-primary btn-sm">
                        ...
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    ...
                                    <h3><?php echo e($stats['classes']); ?></h3>
                                </div>
                                <div class="db-icon">
                                    <img src="<?php echo e(URL::to('assets/img/icons/teacher-icon-02.svg')); ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    ...
                                    <h3><?php echo e($stats['subjects']); ?></h3>
                                </div>
                                <div class="db-icon">
                                    <img src="<?php echo e(URL::to('assets/img/icons/teacher-icon-01.svg')); ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    ...
                                    <h3><?php echo e($stats['sections']); ?></h3>
                                </div>
                                <div class="db-icon">
                                    <img src="<?php echo e(URL::to('assets/img/icons/dash-icon-01.svg')); ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card bg-comman w-100">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    <h6>With Schedule</h6>
                                    <h3><?php echo e($stats['scheduled']); ?></h3>
                                </div>
                                <div class="db-icon">
                                    <img src="<?php echo e(URL::to('assets/img/icons/teacher-icon-03.svg')); ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 text-md-end mt-2 mt-md-0">
                                    <span class="text-muted small"><?php echo e(now()->format('M d, Y g:i A')); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <table class="table table-hover table-center mb-0">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="fw-semibold"><?php echo e($subject->subject_name); ?></div>
                                                        <small class="text-muted"><?php echo e($subject->subject_id ?? ('ID ' . $subject->id)); ?></small>
                                                    </td>
                                                    <td>
                                                        <?php if($section): ?>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-light text-dark">
                                                            <?php echo e($section->grade_level ?? $subject->class ?? 'N/A'); ?>

                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-success-light"><?php echo e($row['students_count']); ?></span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span class="badge <?php echo e($sourceClass); ?>"><?php echo e($sourceLabel); ?></span>
                                                    </td>
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <?php if(Route::has('attendance.index')): ?>
                                                                <a href="<?php echo e(route('attendance.index')); ?>" class="btn btn-sm bg-success-light me-1" title="Attendance">
                                                                    <i class="fas fa-calendar-check"></i>
                                                                </a>
                                                            <?php endif; ?>
                                                            <?php if(Route::has('assignments.create')): ?>
                                                                <a href="<?php echo e(route('assignments.create')); ?>" class="btn btn-sm bg-primary-light me-1" title="Create Assignment">
                                                                    <i class="fas fa-tasks"></i>
                                                                </a>
                                                            <?php endif; ?>
                                                            <?php if(Route::has('lessons.create')): ?>
                                                                <a href="<?php echo e(route('lessons.create')); ?>" class="btn btn-sm bg-info-light" title="Create Lesson">
                        ...
                        <div class="card-body">
                            <?php $__empty_1 = true; $__currentLoopData = $assignedSubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                                    <div>
                                        <div class="fw-semibold"><?php echo e($subject->subject_name); ?></div>
                                        <small class="text-muted"><?php echo e($subject->subject_id); ?> · <?php echo e($subject->class ?? 'N/A'); ?></small>
                                    </div>
                        ...
                        <div class="card-body">
                            <?php $__empty_1 = true; $__currentLoopData = $assignedSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                                    <div>
                                        <div class="fw-semibold"><?php echo e($section->name); ?></div>
                                        <small class="text-muted"><?php echo e($section->grade_level ?? 'N/A'); ?></small>
                                    </div>
                            ...
                            <?php if($adviserSections->isNotEmpty()): ?>
                                ...
                                <?php $__currentLoopData = $adviserSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                                        <div>
                                            <div class="fw-semibold"><?php echo e($section->name); ?></div>
                                            <small class="text-muted"><?php echo e($section->grade_level ?? 'N/A'); ?> · <?php echo e($section->students_count); ?> students</small>
                                        </div>
                                        <span class="badge bg-warning text-dark">Adviser</span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <?php if(Route::has('assignments.create')): ?>
                                <div class="col-md-3">
                                    <a href="<?php echo e(route('assignments.create')); ?>" class="btn btn-primary w-100 py-3">
                                        <i class="fas fa-tasks d-block mb-1"></i> Create Assignment
                                    </a>
                                </div>
                                <?php endif; ?>
                                <?php if(Route::has('class-posts.create')): ?>
                                <div class="col-md-3">
                                    <a href="<?php echo e(route('class-posts.create')); ?>" class="btn btn-success w-100 py-3">
                                ...
                                <?php if(Route::has('lessons.create')): ?>
                                <div class="col-md-3">
                                    <a href="<?php echo e(route('lessons.create')); ?>" class="btn btn-info w-100 py-3">
                                ...
                                <?php if(Route::has('attendance.index')): ?>
                                <div class="col-md-3">
                                    <a href="<?php echo e(route('attendance.index')); ?>" class="btn btn-warning w-100 py-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\teacher\classes.blade.php ENDPATH**/ ?>