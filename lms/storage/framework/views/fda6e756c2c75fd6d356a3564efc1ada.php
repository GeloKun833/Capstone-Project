...
<div class="page-wrapper">
    <div class="content container-fluid dir-page">
        ...
        <div class="page-header">
            <div class="row align-items-start">
                <div class="col">
                    ...
                    <p class="dir-subtitle">Add a student task for <?php echo e($lesson->title); ?>.</p>
                </div>
                <div class="col-auto text-end">
                    ...
                    <a href="<?php echo e(route('lessons.activities.index', $lesson)); ?>" class="btn btn-outline-secondary dir-btn">Back</a>
                </div>
            </div>
        </div>
        ...
        <form action="<?php echo e(route('lessons.activities.store', $lesson)); ?>" method="POST" id="activityForm">
            <?php echo csrf_field(); ?>
            <div class="row g-3">
                <div class="col-lg-8">
                    <div class="dir-card">
...
unset($__errorArgs, $__bag); ?>" id="title" name="title"
                                       value="<?php echo e(old('title')); ?>" placeholder="e.g. Count and Match worksheet" required>
...
unset($__errorArgs, $__bag); ?>" id="instructions" name="instructions"
                                          rows="6" placeholder="Tell students what to do, what to submit, and how you will check their work." required><?php echo e(old('instructions')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="due_date" name="due_date"
                                       value="<?php echo e(old('due_date', now()->addDays(7)->toDateString())); ?>" min="<?php echo e(now()->toDateString()); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <label class="act-toggle <?php echo e(old('allows_submission') ? 'is-on' : ''); ?>" id="submissionToggle">
                                <input class="form-check-input" type="checkbox" id="allows_submission" name="allows_submission" value="1"
                                       <?php echo e(old('allows_submission') ? 'checked' : ''); ?>>
                                <span>
                    ...
                    <div class="d-flex gap-2 mt-3">
                        ...
                        <a href="<?php echo e(route('lessons.activities.index', $lesson)); ?>" class="btn btn-outline-secondary dir-btn">Cancel</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="dir-card mb-3">
                        <div class="p-3 p-md-4">
                            ...
                            <div class="act-fact"><span>Lesson</span><strong><?php echo e($lesson->title); ?></strong></div>
                            <div class="act-fact"><span>Subject</span><strong><?php echo e($lesson->subject->subject_name ?? '—'); ?></strong></div>
                            <div class="act-fact"><span>Section</span><strong><?php echo e($lesson->section->name ?? '—'); ?></strong></div>
                            <div class="act-fact"><span>Lesson date</span><strong><?php echo e(optional($lesson->lesson_date)->format('M j, Y') ?? '—'); ?></strong></div>
                        </div>
                    </div>
                    <div class="dir-card">
                        <div class="p-3 p-md-4">
...
<link rel="stylesheet" href="<?php echo e(asset('assets/css/directory-modern.css')); ?>?v=20260915a">
<style>
.act-toggle {
    display: flex;
    gap: 0.75rem;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views/activities/create.blade.php ENDPATH**/ ?>