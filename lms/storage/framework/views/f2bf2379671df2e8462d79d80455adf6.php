            ...
            <div class="row">
                <div class="col-xl-3 col-md-4">
                    <div class="widget settings-menu">
                        <ul>
                            <li class="nav-item">
                                <a href="<?php echo e(route('setting/page')); ?>" class="nav-link active">
                                    <i class="fe fe-git-commit"></i> <span>General Settings</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('invoice/settings/tax/page')); ?>" class="nav-link">
                                    <i class="fe fe-bookmark"></i> <span>Tax Settings</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('invoice/settings/bank/page')); ?>" class="nav-link">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\invoices\settings\settings_invoices.blade.php ENDPATH**/ ?>