                                ...
                                <div class="schedule-grid">
                                    <div class="time-column">
                                        ...
                                        <?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="time-slot"><?php echo e($slot->format('g:i A')); ?></div>
                                    ...
                                    <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="day-column">
                                            <div class="day-header"><?php echo e($dayNames[$index]); ?></div>
                                            <?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $slotStart = $slot->copy();
                                                ...
                                                <?php if($schedule && !$isOccupied): ?>
                                                    ...
                                                    <div class="schedule-block"
                                                         ...
                                                         title="<?php echo e($schedule->subject->subject_name); ?> — <?php echo e(\Carbon\Carbon::parse($schedule->start_time)->format('g:i A')); ?>-<?php echo e(\Carbon\Carbon::parse($schedule->end_time)->format('g:i A')); ?> — <?php echo e($schedule->section->name); ?> — <?php echo e($schedule->room->room_name ?? 'TBD'); ?>">
                                                        <div class="schedule-content">
                                                            ...
                                                            <div class="class-type"><?php echo e(\Carbon\Carbon::parse($schedule->start_time)->format('g:i A')); ?></div>
                                                            <div class="section-name"><?php echo e($schedule->section->name); ?></div>
                                                            <div class="room-name"><?php echo e($schedule->room->room_name ?? 'TBD'); ?></div>
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\schedule\teacher-schedule.blade.php ENDPATH**/ ?>