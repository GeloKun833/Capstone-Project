        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="<?php echo e(route('invoice/draft/page')); ?>" class="invoices-links active">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-8 col-md-8">
                                <div class="invoices-tabs">
                                    <ul>
                                        <li><a href="<?php echo e(route('invoice/list/page')); ?>">All Invoice</a></li>
                                        <li><a href="<?php echo e(route('invoice/paid/page')); ?>">Paid</a></li>
                                        <li><a href="<?php echo e(route('invoice/overdue/page')); ?>">Overdue</a></li>
                                        <li><a class="active" href="<?php echo e(route('invoice/draft/page')); ?>">Draft</a></li>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <h2 class="table-avatar">
                                                    <a href="profile.html">
                                                        <img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="<?php echo e(URL::to('/images/photo_defaults.jpg')); ?>" alt="User Image"> StarCode Moore
                                                    </a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <h2 class="table-avatar">
                                                    <a href="profile.html">
                                                        <img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="<?php echo e(URL::to('/images/photo_defaults.jpg')); ?>" alt="User Image"> StarCode Moore</a>
                                                </h2>
                                            </td>
                                            <td class="text-primary">$1,54,220</td>
                                            <td>16 Mar 2022</td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Capstone-Project\lms\resources\views\invoices\tab\draft_invoices.blade.php ENDPATH**/ ?>