...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="student_id" class="form-control" value="<?php echo e(old('student_id', $student->admission_id)); ?>" readonly>
                            </div>
                            <?php endif; ?>
                            <?php if($user->role_name === \App\Models\User::ROLE_TEACHER && $teacher): ?>
                            <div class="form-group">
                                <label>Teacher ID</label>
                                <input type="text" name="teacher_id" class="form-control" value="<?php echo e(old('teacher_id', $teacher->teacher_id)); ?>" readonly>
                            </div>
                            <?php endif; ?>
