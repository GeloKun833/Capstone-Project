                            ...
                            <table class="table table-hover table-center table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-info">{{ $enrollment['subject_name'] }}</span>
                                            @if($enrollment['type'] === 'portal_student')
                                                <br><small class="text-success"><i class="fas fa-globe"></i> Portal</small>
                                            @endif
                                        </td>
                                        <td>
                                            <span class="badge badge-secondary">{{ $enrollment['section_name'] }}</span>
                                        </td>
                                        ...
                                        <td>{{ $enrollment['enrollment_date'] ? \Carbon\Carbon::parse($enrollment['enrollment_date'])->format('M d, Y') : 'N/A' }}</td>
                                        <td>
                                            <div class="actions">
                                                @if($enrollment['type'] === 'enrollment')
                                                ...
                                                @else
                                                    <a href="{{ route('enrollment.registrar.show', $enrollment['id']) }}" class="btn btn-sm btn-info">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                            ...
                            <div class="d-flex justify-content-between align-items-center flex-wrap">
                                <div class="pagination-info mb-2 mb-md-0">
                                    <p class="text-muted mb-0">
                                        Showing {{ $paginatedEnrollments->firstItem() }} to {{ $paginatedEnrollments->lastItem() }} of {{ $paginatedEnrollments->total() }} results
                                    </p>
                                </div>
