{{-- Shared contact cards shown on every role dashboard --}}
@php
    $defaults = [
...
<div class="row">
    <div class="col-xl-4 col-sm-6 col-12">
        <a href="tel:{{ preg_replace('/\D+/', '', $schoolContact['phone']) }}" class="text-decoration-none">
            <div class="card flex-fill fb sm-box">
                <div class="social-likes">
                    <p>Contact</p>
                    <h6>{{ $schoolContact['phone'] }}</h6>
    ...
    <div class="col-xl-4 col-sm-6 col-12">
        <a href="{{ $schoolContact['facebook'] }}" target="_blank" rel="noopener noreferrer" class="text-decoration-none">
    ...
    <div class="col-xl-4 col-sm-6 col-12">
        <a href="mailto:{{ $schoolContact['email'] }}" class="text-decoration-none">
            <div class="card flex-fill insta sm-box">
                <div class="social-likes">
                    <p>Gmail</p>
                    <h6 style="font-size:.95rem;word-break:break-all;">{{ $schoolContact['email'] }}</h6>
                    <small class="text-white-50 d-block mt-1" style="opacity:.85;font-size:.75rem;">
                        Email the school
                    </small>
                </div>
