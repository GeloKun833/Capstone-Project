            ...
            <div class="card-body">
                ...
                <p class="text-muted mb-4">
                    ...
                    @if($calendarEvent->is_all_day)
                        All day
                    @else
                        {{ $calendarEvent->start_time->format('g:i A') }} – {{ $calendarEvent->end_time->format('g:i A') }}
                    @endif
                </p>
                ...
                @endif
                @if($calendarEvent->subject && $calendarEvent->subject->class)
                    <p><strong>Class:</strong> {{ $calendarEvent->subject->class }}</p>
                @endif
