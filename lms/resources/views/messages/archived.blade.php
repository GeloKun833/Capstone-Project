        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Archived Messages</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Archived Messages</li>
                        </ul>
                    </div>
            ...
            <div class="student-group-form">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="form-group">
                            <a href="{{ route('messages.archived') }}" class="btn btn-primary w-100">
                        ...
                        <div class="card-body">
                            ...
                            @if($messages->count() == 0)
                                <div class="text-center py-5">
                                    <div class="mb-4">
                                        <i class="fas fa-archive text-primary" style="font-size: 4rem; opacity: 0.6;"></i>
                                    </div>
                                    <h4 class="fw-bold text-dark mb-3">No Archived Messages</h4>
                                    <p class="text-muted mb-4">You haven't archived any messages yet. Archived messages will appear here.</p>
                                    <a href="{{ route('messages.create') }}" class="btn btn-primary">
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            ...
                                                            @if($message->sender_id == Auth::id())
                                                                <span class="text-muted">To: </span>{{ $message->recipient->name ?? 'Unknown User' }}
                                                            @else
                                                                <span class="text-muted">From: </span>{{ $message->sender->name ?? 'Unknown User' }}
                                                            @endif
                                                        </h2>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            ...
                                                            <button type="button" class="btn btn-sm bg-warning-light me-2" onclick="unarchiveMessage({{ $message->id }})">
...
function unarchiveMessage(messageId) {
    if (confirm('Are you sure you want to unarchive this message?')) {
        fetch(`/messages/${messageId}/unarchive`, {
            method: 'PATCH',
            headers: {
