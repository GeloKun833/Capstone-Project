            ...
            <div class="col-md-12">
                ...
                <div class="tab-content profile-tab-cont">
                    ...
                    <div class="tab-pane fade show active" id="per_details_tab">
                        ...
                        @else
                            {{-- Default Profile for Non-Students --}}
                            <div class="row">
                                <div class="col-lg-9">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title d-flex justify-content-between">
                                                ...
                                                <a class="edit-link" href="{{ route('user/profile/edit') }}"><i
                                            ...
                                            <div class="row">
                                                ...
                                                <p class="col-sm-9">{{ Session::get('phone_number') ?? 'N/A' }}</p>
                                            </div>
                                            <div class="row">
                                                <p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Position</p>
                                                <p class="col-sm-9">{{ Session::get('position') }}</p>
                                            </div>
                                            <div class="row">
                                                <p class="col-sm-3 text-muted text-sm-end mb-0">Department</p>
                                                <p class="col-sm-9 mb-0">{{ Session::get('department') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
